...
<div style="position:absolute;
    ...
    <div class="top-banner">
        ...
        <strong style="position: relative; padding-bottom: -20px; font-weight: 600; line-height: 1; font-size: 250px; font-family: Arial, Helvetica, sans-serif">{{$barcode}}</strong>
